...
ylabel('N [m]');
title('Positin: Observer performance with loss of signal for 1 second')
...
set(hleg, 'Interpreter','Latex');
ylabel('u [m/s]');
title('Velocity: Observer performance with loss of signals for 1 second')
...
xlabel('Time (s)')
title('Bias Estimate as a function of time with loss of signals for 1 second')
