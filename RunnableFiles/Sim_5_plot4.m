...
ylabel('N [m]');
title('Positin: Observer performance with user defined inputs')
...
set(hleg, 'Interpreter','Latex');
ylabel('u [m/s]');
title('Velocity: Observer performance with user defined inputs')
...
xlabel('Time (s)')
title('Bias Estimate as a function of time with user defined inputs')
