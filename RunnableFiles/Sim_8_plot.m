...
ylabel('North');
xlabel('East');
title('Simulation 8 - straight line with integral action')
...
xlabel('Time[s]');
title('Simulation 8 - Commanded control input to each thruster, with integral action')
subplot(2,1,2)
...
xlabel('Time[s]');
title('Simulation 8 - Reference forces from controller, with integral action ')
...
xlabel('Time (s)')
title('Sim 8 - Bias Estimate as a function of time with user defined inputs')
