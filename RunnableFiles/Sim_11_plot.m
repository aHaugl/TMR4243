...
ylabel('North');
xlabel('East');
title('Simulation 11 - straight line with integral action')
...
xlabel('Time[s]');
title('Commanded control input to each thruster, with integral action')
subplot(2,1,2)
...
xlabel('Time[s]');
title('Reference forces from controller, with integral action ')
...
set(hleg, 'Interpreter','Latex');
ylabel('x [m]');
title('Sim 11 - NED positions \eta')
...
xlabel('Time (s)')
title('Sim 11 - Bias Estimate as a function of time with user defined inputs')
