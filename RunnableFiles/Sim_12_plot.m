...
ylabel('North');
xlabel('East');
title('Simulation 12 - elipsoid with integral action')
...
title('Sim 12 - Measurements are available vs ship in dead reckoning')
ylabel('Yes/No')
xlabel('Time(s)')
...
xlabel('Time (s)')
title('Sim 12 - Bias Estimate as a function of time with user defined inputs')
...
set(hleg, 'Interpreter','Latex');
ylabel('N [m]');
title('Sim 12 - NED positions \eta')
