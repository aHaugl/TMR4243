...
ylabel('North');
xlabel('East');
title('Simulation 9 - ellipsoid without integral action')
...
xlabel('Time[s]');
title('Simulation 9 - Commanded control input to each thruster, without integral action')
subplot(2,1,2)
...
xlabel('Time[s]');
title('Simulation 9 - Reference forces from controller, without integral action ')
...
xlabel('Time (s)')
title('Sim 9 - Bias Estimate as a function of time with user defined inputs')
